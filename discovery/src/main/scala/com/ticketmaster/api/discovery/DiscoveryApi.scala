...
case class SearchEventsRequest(keyword: Filter[String] = NoFilter,
                               ...
                               countryCode: Filter[String] = NoFilter,
                               ...
                               onsaleStartDateTime: Filter[ZonedDateTime] = NoFilter,
                               onsaleEndDateTime: Filter[ZonedDateTime] = NoFilter,
                               city: Filter[String] = NoFilter,
                               stateCode: Filter[String] = NoFilter,
                               classificationName: Filter[String] = NoFilter,
                               classificationId: Filter[String] = NoFilter,
