...
trait HttpDiscoveryApi extends DiscoveryApi with HttpHandler {
  ...
  override def searchEvents(searchEventsRequest: SearchEventsRequest)(implicit ec: ExecutionContext): Future[PageResponse[Events]] = {
    val filters = Map[String, Filter[_]]()
      ...
      .updated("unit", searchEventsRequest.unit)
      .updated("source", searchEventsRequest.source)
      .updated("countryCode", searchEventsRequest.countryCode)
      ...
      .updated("onsaleStartDateTime", searchEventsRequest.onsaleStartDateTime)
      .updated("onsaleEndDateTime", searchEventsRequest.onsaleEndDateTime)
      .updated("city", searchEventsRequest.city)
      .updated("stateCode", searchEventsRequest.stateCode)
      .updated("classificationName", searchEventsRequest.classificationName)
      .updated("classificationId", searchEventsRequest.classificationId)
